...
import { ArrowLeft, CheckCircle2, FileText, ScrollText } from 'lucide-react';
...
export function Step5Consent({ onNext, onBack, initialConsent = false }: Step5ConsentProps) {
  ...
  const [consentChecked, setConsentChecked] = useState(initialConsent);
      ...
      <div className="relative">
        ...
        >
          ...
          <section className="space-y-2">
            ...
            <p>
              Como titular del comercio, te comprometés a:
            </p>
        ...
        {/* Fade gradient at bottom when not scrolled to end */}
        {!hasScrolledToBottom && (
          <div

...
export default function DeleteModal({ historyId, historyDescription }: DeleteModalProps) {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white p-6 rounded-lg shadow-lg max-w-md w-full mx-4 text-center">
        <h3 className="text-lg font-semibold mb-4">Delete History Record</h3>
        <p className="text-gray-600 mb-6">
          Are you sure you want to delete history record <strong>{historyDescription}</strong>? This action cannot be undone.
        </p>

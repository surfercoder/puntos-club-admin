...
// seccion, "- " = item de lista, el resto es parrafo. Lo lee app/legal/[doc].
//
// Copia de PuntosClub/constants/legal.ts. Los tres proyectos (las dos apps y
// este admin) tienen que mostrar EXACTAMENTE el mismo texto: la version que el
// beneficiario acepta en el alta queda guardada en beneficiary.privacy_version,
// y Google Play contrasta la Data Safety contra la politica publicada aca.
//

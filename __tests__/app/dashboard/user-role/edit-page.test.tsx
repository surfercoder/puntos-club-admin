...
import EditUserRolePage from '@/app/dashboard/user-role/edit/[id]/page';
...
describe('EditUserRolePage', () => {
  it('exports a default async function', () => {
    expect(typeof EditUserRolePage).toBe('function');
  });

  it('renders without crashing', async () => {
    const result = await EditUserRolePage({ params: Promise.resolve({ id: '1' }) });
  ...
  it('renders error when fetch fails', async () => {
    ...
    await EditUserRolePage({ params: Promise.resolve({ id: '999' }) });

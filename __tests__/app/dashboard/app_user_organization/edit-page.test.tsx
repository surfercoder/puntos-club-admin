...
import EditAppUserOrganizationPage from '@/app/dashboard/app_user_organization/edit/[id]/page';
...
describe('EditAppUserOrganizationPage', () => {
  it('exports a default async function', () => { expect(typeof EditAppUserOrganizationPage).toBe('function'); });
  it('renders without crashing', async () => { const result = await EditAppUserOrganizationPage({ params: Promise.resolve({ id: '1' }) }); expect(result).toBeTruthy(); });
  ...
  it('calls notFound when data is null', async () => {
    ...
    await EditAppUserOrganizationPage({ params: Promise.resolve({ id: '999' }) });
  ...
  it('renders error when fetch fails', async () => {
    ...
    const result = await EditAppUserOrganizationPage({ params: Promise.resolve({ id: '999' }) });

...
describe('DeleteModal', () => {
  ...
  it('shows fallback error toast when deletePurchase returns failure with no error message', async () => {
    mockDeletePurchase.mockResolvedValue({ success: false, error: undefined } as any);

...
describe('DeleteModal (notifications)', () => {
  ...
  it('renders the trigger button and dialog content', () => {
    render(<DeleteModal notificationId="n-1" notificationTitle="Test Notification" />);
  ...
  it('calls deletePushNotification and shows success toast', async () => {
    ...
    await waitFor(() => {
      expect(mockDeletePushNotification).toHaveBeenCalledWith('n-1');
    });
